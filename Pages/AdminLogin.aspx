    ...
    <div>
        <table align="center">
            ...
            <tr>
                ...
                <td>
                    <br />
                    <asp:HyperLink ID="HyperLink1" runat="server" ForeColor="#0000CC" NavigateUrl="~/Pages/AdminReg.aspx"
                        CssClass="boldTextMedium">New Admin Register Here</asp:HyperLink>
                </td>
            </tr>
        </table>
    </div>
